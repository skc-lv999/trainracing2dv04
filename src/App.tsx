...
export default function App() {
  ...
  const [activeModal, setActiveModal] = useState<"none" | "game_start" | "stage_select" | "train_select" | "ranking" | "options" | "news" | "how_to_play">("none");
  ...
  const transparentLogo = useTransparentImage("/src/assets/images/title_logo_1781676307212.jpg");
      ...
      {activeScreen === "lobby" && (
        ...
        >
          ...
          <div 
            ...
            style={{
              backgroundImage: `url("/src/assets/images/clean_train_lobby_1781676082510.jpg")`,
            }}
          />
          ...
          {!isLobbyStarted ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center relative z-10 text-center select-none space-y-12 my-auto">
              ...
              <div className="max-w-[700px] md:max-w-[1000px] mx-auto transition-transform duration-300 transform hover:scale-102 flex justify-center drop-shadow-[0_25px_50px_rgba(0,0,0,0.7)] w-[95%]">
                <img 
                  src={transparentLogo} 
                    ...
                    {activeModal === "stage_select" && (
                      <div className="space-y-5">
                        <p className="text-sm text-slate-300 text-center mb-3 font-sans">
                          高速で並走対決する路線ダイヤを選択してください。車両も自動的に割り当てられます。
                        </p>
